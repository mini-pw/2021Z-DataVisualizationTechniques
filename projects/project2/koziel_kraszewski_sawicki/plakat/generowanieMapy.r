...
rok2019 <- read.csv("waqi-covid-2019Q1.csv", skip = 4)
rok2019_2 <- read.csv("waqi-covid-2019Q2.csv", skip = 4)
rok2019_3 <- read.csv("waqi-covid-2019Q3.csv", skip = 4)
rok2019_4 <- read.csv("waqi-covid-2019Q4.csv", skip = 4)
rok2019 <- rbind(rok2019, rok2019_2, rok2019_3, rok2019_4)

rok2018 <- read.csv("waqi-covid-2018H1.csv", skip = 4)
rok2017 <- read.csv("waqi-covid-2017H1.csv", skip = 4)
rok2016 <- read.csv("waqi-covid-2016H1.csv", skip = 4)
