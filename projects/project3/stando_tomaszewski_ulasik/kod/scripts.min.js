...
"use strict";!function(n){n("#sidebarToggle, #sidebarToggleTop").on("click",function(o){n("body").toggleClass("sidebar-toggled"),n(".sidebar").toggleClass("toggled")}),n(window).resize(function(){n(window).width()<480&&!n(".sidebar").hasClass("toggled")&&(n("body").addClass("sidebar-toggled"),n(".sidebar").addClass("toggled"))}),n("body.fixed-nav .sidebar").on("mousewheel DOMMouseScroll wheel",function(o){if(768<n(window).width()){var e=o.originalEvent,t=e.wheelDelta||-e.detail;this.scrollTop+=30*(t<0?1:-1),o.preventDefault()}}),n(document).on("click","a.scroll-to-top",function(o){var e=n(this);n("html, body").stop().animate({scrollTop:n(e.attr("href")).offset().top},1e3,"easeInOutExpo"),o.preventDefault()}),n('[data-toggle="popover"]').popover({html:!0}),n("iframe").each(function(){this.contentWindow.console.log=function(){},this.contentWindow.console.warn=function(){},this.contentWindow.console.error=function(){}}),console.log("Font Awesome Free 5.15.1 by @fontawesome - https://fontawesome.com\n  License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License)\n  ")}(jQuery);
"use strict";function createThemedTooltip(t){var e=t.append("div").style("opacity",0).style("transition","opacity 0.5s").attr("class","tooltip card shadow p-1").style("pointer-events","none");return e.append("div").attr("class","tooltip-title text-primary text-uppercase font-weight-bold").style("font-size","0.8rem"),e.append("span").attr("class","tooltip-value text-gray-800 font-weight-bold").style("font-size","1rem"),e.append("span").attr("class","tooltip-sub-value text-gray-300 font-weight-bold").style("font-size","1rem"),e.selectAll("*").style("pointer-events","none"),e}
"use strict";function updateMmmChart(e){var d=null;function t(e,t,M){if($("#"+e+" .MMM-title").text(M),t){$("#"+e+" .MMM-video").attr("src")!="https://www.youtube.com/embed/"+t.id+"?rel=0"&&$("#"+e+" .MMM-video").attr("src","https://www.youtube.com/embed/"+t.id+"?rel=0");var i=SELECTED_DATATYPE;"General"==SELECTED_DATATYPE&&(i="Times viewed"),null==d&&(d=t[i]),$("#"+e+" .MMM-value").text(DATATYPES_DEFINITIONS[i].format(t[i],d)),$("#"+e+" .MMM-sub-value").text(" "+DATATYPES_DEFINITIONS[i].suffixName)}else $("#"+e+" .MMM-value").text(""),$("#"+e+" .MMM-sub-value").text("---"),"https://www.youtube.com/embed/"!=$("#"+e+" .MMM-video").attr("src")&&$("#"+e+" .MMM-video").attr("src","https://www.youtube.com/embed/")}var M=[];if("General"==SELECTED_DATATYPE){var i={};t("MMM-Min",(M=e.sort(function(e,t){return t["Times viewed"]-e["Times viewed"]!=0?t["Times viewed"]-e["Times viewed"]:e.time-t.time}).filter(function(e){var t=!i[e.id];return i[e.id]=!0,t}))[0],"Most viewed video"),t("MMM-Med",M[1],"Second most viewed video"),t("MMM-Max",M[2],"Third most viewed video")}else{t("MMM-Max",(M=e.sort(function(e,t){return e[SELECTED_DATATYPE]-t[SELECTED_DATATYPE]!=0?e[SELECTED_DATATYPE]-t[SELECTED_DATATYPE]:t.time-e.time}))[M.length-1],"Maximum from viewed videos"),t("MMM-Med",M[Math.floor(M.length/2)],"Median from viewed videos"),t("MMM-Min",M[0],"Minimum from viewed videos")}}
"use strict";function _slicedToArray(t,e){return _arrayWithHoles(t)||_iterableToArrayLimit(t,e)||_unsupportedIterableToArray(t,e)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var r=Object.prototype.toString.call(t).slice(8,-1);return"Object"===r&&t.constructor&&(r=t.constructor.name),"Map"===r||"Set"===r?Array.from(t):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?_arrayLikeToArray(t,e):void 0}}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var r=0,o=new Array(e);r<e;r++)o[r]=t[r];return o}function _iterableToArrayLimit(t,e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(t)){var r=[],o=!0,n=!1,i=void 0;try{for(var l,a=t[Symbol.iterator]();!(o=(l=a.next()).done)&&(r.push(l.value),!e||r.length!==e);o=!0);}catch(t){n=!0,i=t}finally{try{o||null==a.return||a.return()}finally{if(n)throw i}}return r}}function _arrayWithHoles(t){if(Array.isArray(t))return t}var linePlotChart,linePlotMaxValue;function initLinePlot(){linePlotChart=new Chart($("#linePlot"),{type:"line",data:{datasets:[{data:[],fill:!1,borderColor:"#ff6961"}]},options:{responsive:!0,legend:{display:!1},scales:{xAxes:[{type:"time",distribution:"series",time:{parser:"YYYY-MM-DD"},scaleLabel:{display:!0,labelString:"Date",fontColor:"#ff6961",fontSize:16},ticks:{fontColor:"#ff6961",fontSize:14}}],yAxes:[{type:"logarithmic",scaleLabel:{display:!0,fontColor:"#ff6961",fontSize:16},ticks:{fontColor:"#ff6961",autoSkipPadding:45,fontSize:14}}]},tooltips:{enabled:!1,custom:function(t){var e=d3.select("#chartjs-lineplot-tooltip");if(e.empty()&&(e=createThemedTooltip(d3.select("body")).attr("id","chartjs-lineplot-tooltip").style("transition","left 0.3s, top 0.3s")),0!==t.opacity){if(t.body){var r=(t.title||[])[0],o=t.body[0].lines[0],n=DATATYPES_DEFINITIONS[SELECTED_DATATYPE];e.select(".tooltip-value").text(n.format(o,linePlotMaxValue)),e.select(".tooltip-sub-value").text(" "+n.suffixName),"General"==SELECTED_DATATYPE?e.select(".tooltip-title").text("Value for "+r):e.select(".tooltip-title").text("Median for "+r)}var i=this._chart.canvas.getBoundingClientRect(),l=e.node().getBoundingClientRect();e.style("opacity",1),e.style("position","absolute"),e.style("left",i.left+window.pageXOffset+t.caretX+"px"),e.style("top",i.top+window.pageYOffset+t.caretY-l.height+"px")}else e.style("opacity",0)}}}})}function updateLinePlot(t){var e=d3.nest().key(function(t){var e=new Date(t.time);return e.setHours(0),e.setMinutes(0),e.setSeconds(0),e.setMilliseconds(0),e.getFullYear()+"-"+("0"+(e.getMonth()+1)).slice(-2)});e=(e="General"==SELECTED_DATATYPE?e.rollup(function(t){return t.length}):e.rollup(function(t){return d3.median(t,function(t){return+t[SELECTED_DATATYPE]})})).entries(t);var r="%Y-%m",o=[];linePlotMaxValue=d3.max(e,function(t){return t.value});for(var n=0,i=Object.entries(e);n<i.length;n++){var l=_slicedToArray(i[n],2),a=(l[0],l[1]);o.push({x:a.key,y:a.value})}o=o.sort(function(t,e){return d3.timeParse(r)(t.x)-d3.timeParse(r)(e.x)}),"General"==SELECTED_DATATYPE?$("#linePlotTitle").text("Videos viewed over time"):$("#linePlotTitle").text("Viewing preferences over time"),linePlotChart.data.datasets[0].data=o,linePlotChart.options.scales.yAxes[0].scaleLabel.labelString="General"==SELECTED_DATATYPE?"Viewed videos":SELECTED_DATATYPE,linePlotChart.options.scales.yAxes[0].ticks.callback=0==d3.max(o,function(t){return t.y})?function(t,e,r){if(e==r.length-1)return 0}:function(t,e,r){if(DATATYPES_DEFINITIONS)return DATATYPES_DEFINITIONS[SELECTED_DATATYPE].format(t,linePlotMaxValue)},linePlotChart.update()}
"use strict";var heatMapMaxVal;function initHeatMap(){var t=450-60-30,e=450-10-30,a=d3.select("#heatmap").append("svg").attr("viewBox","-40 0 400 430").attr("preserveAspectRatio","xMinYMin"),n=d3.scaleBand().range([0,t]).domain([1,2,3,4,5,6,7]).padding(.05),l=["Mon.","Tue.","Wed.","Thu.","Fri.","Sat.","Sun."];a.append("g").style("font-size",15).attr("transform","translate(0,"+e+")").call(d3.axisBottom(n).tickSize(0).tickFormat(function(t){return l[t-1]})).call(function(t){return t.select(".domain").remove()}).call(function(t){return t.selectAll("text").style("fill","#ff6961")});var r=d3.scaleBand().range([e,0]).domain(Array.from({length:24},function(t,e){return 23-e})).padding(.05);a.append("g").style("font-size",15).call(d3.axisLeft(r).tickSize(0).tickFormat(function(t){return t+":00"})).call(function(t){return t.select(".domain").remove()}).call(function(t){return t.selectAll("text").style("fill","#ff6961")});for(var o=createThemedTooltip(d3.select("#heatmap")),i=[],u=1;u<8;u++)for(var s=0;s<24;s++)i.push({day:u,hour:s});a.selectAll().data(i,function(t){return t.day+":"+t.hour}).enter().append("rect").attr("x",function(t){return n(t.day)}).attr("y",function(t){return r(t.hour)}).attr("rx",4).attr("ry",4).attr("width",n.bandwidth()).attr("height",r.bandwidth()).style("stroke-width",4).style("stroke","none").style("transition","fill 1s").on("mouseover",function(){o.style("opacity",1),d3.select(this).style("stroke","black")}).on("mousemove",function(t){if(o.style("left",d3.event.pageX-this.parentNode.getBoundingClientRect().x+20+"px").style("bottom",this.parentNode.getBoundingClientRect().height-d3.event.pageY+this.parentNode.getBoundingClientRect().y+18+"px"),null===t.val)o.select(".tooltip-value").text(""),o.select(".tooltip-sub-value").text("No videos viewed");else{var e=DATATYPES_DEFINITIONS[SELECTED_DATATYPE];o.select(".tooltip-value").text(e.format(t.val,heatMapMaxVal)),o.select(".tooltip-sub-value").text(" "+e.suffixName),"General"==SELECTED_DATATYPE?o.select(".tooltip-title").text("Value for this timeframe"):o.select(".tooltip-title").text("Median for this timeframe")}}).on("mouseleave",function(){o.style("opacity",0),d3.select(this).style("stroke","none")})}function updateHeatMap(t){var e=d3.nest().key(function(t){return new Date(t.time).getDay()+1}).key(function(t){return new Date(t.time).getHours()});e=(e="General"==SELECTED_DATATYPE?e.rollup(function(t){return t.length}):e.rollup(function(t){return d3.median(t,function(t){return+t[SELECTED_DATATYPE]})})).entries(t);for(var a=[],n=1;n<8;n++)for(var l=0;l<24;l++)a.push({day:n,hour:l,val:null});e.forEach(function(e){e.values.forEach(function(t){a[24*(e.key-1)+ +t.key].val=t.value})}),"General"==SELECTED_DATATYPE?$("#heatMapTitle").text("Videos viewed throughout the week"):$("#heatMapTitle").text("Viewing preferences throughout the week"),heatMapMaxVal=d3.max(a.filter(function(t){return null!=t.val}),function(t){return+t.val});var r=d3.min(a.filter(function(t){return null!=t.val}),function(t){return+t.val}),o=d3.scaleSequential().interpolator(d3.interpolateInferno).domain([Math.log10(r+1),Math.log10(heatMapMaxVal+1)]);d3.select("#heatmap svg").selectAll("rect").data(a,function(t){return t.day+":"+t.hour}).style("fill",function(t){return null===t.val?"transparent":o(Math.log10(t.val+1))}),continuousLegend(o)}function continuousLegend(e){var l=e.domain(),a=d3.scaleLinear().range(l).domain(l),n=[];if(isNaN(l[0])||l[0]==l[1])for(var t=0;t<250;t++)n.push({color:"#000000",value:(t+1)/250});else d3.range(l[0],l[1],(l[1]-l[0])/250).forEach(function(t){n.push({color:e(a.invert(t)),value:t})});var r=d3.extent(n,function(t){return t.value}),o=d3.scaleLinear().range([0,302]).domain(r),i=[];i.push(n[0].value),i.push(n[83].value),i.push(n[166].value),i.push(n[249].value);var u=Math.pow(10,n[249].value)-1,s=d3.axisBottom(o).tickSize(16).tickValues(i).tickFormat(function(t,e,a){var n=[Math.floor,Math.round,Math.round,Math.ceil];return l[0]==l[1]?isNaN(l[0])?0:l[0]:DATATYPES_DEFINITIONS[SELECTED_DATATYPE].format(prettyPowerOf10(t,n[e]),u)});d3.select("#heatmaplegend").selectAll("svg").remove();var c=d3.select("#heatmaplegend").append("svg").attr("viewBox","-40 0 400 58").attr("preserveAspectRatio","xMinYMin"),d=c.append("g").attr("transform","translate(9, 0)");c.append("defs").append("linearGradient").attr("id","myGradient").selectAll("stop").data(n).enter().append("stop").attr("offset",function(t){return(t.value-r[0])/(r[1]-r[0])*100+"%"}).attr("stop-color",function(t){return t.color}),d.append("text").attr("class","x label").attr("text-anchor","middle").attr("width",302).attr("x",151).attr("y",21).style("fill","#ff6961").style("font-size",14).text("General"==SELECTED_DATATYPE?"Videos viewed":SELECTED_DATATYPE),d.append("rect").attr("width",302).attr("height",8).attr("y",25).style("fill","url(#myGradient)"),d.append("g").call(s).attr("transform","translate(0, 25)").call(function(t){return t.selectAll("text").style("fill","#ff6961")}).call(function(t){return t.selectAll("text").style("font-size",15)}).call(function(t){return t.selectAll("path").style("stroke","#ff6961")}).call(function(t){return t.selectAll("line").style("stroke","#ff6961")})}
"use strict";function _slicedToArray(t,e){return _arrayWithHoles(t)||_iterableToArrayLimit(t,e)||_unsupportedIterableToArray(t,e)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var r=Object.prototype.toString.call(t).slice(8,-1);return"Object"===r&&t.constructor&&(r=t.constructor.name),"Map"===r||"Set"===r?Array.from(t):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?_arrayLikeToArray(t,e):void 0}}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var r=0,a=new Array(e);r<e;r++)a[r]=t[r];return a}function _iterableToArrayLimit(t,e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(t)){var r=[],a=!0,o=!1,n=void 0;try{for(var i,s=t[Symbol.iterator]();!(a=(i=s.next()).done)&&(r.push(i.value),!e||r.length!==e);a=!0);}catch(t){o=!0,n=t}finally{try{a||null==s.return||s.return()}finally{if(o)throw n}}return r}}function _arrayWithHoles(t){if(Array.isArray(t))return t}var histogramPlot;function initHistogram(){var t=document.getElementById("histogram");histogramChart=new Chart(t,{type:"bar",data:{datasets:[{data:[],backgroundColor:"#C34A36",barPercentage:1,categoryPercentage:.92}]},options:{responsive:!0,legend:{display:!1},scales:{xAxes:[{display:!1},{ticks:{fontColor:"#ff6961",fontSize:14},scaleLabel:{display:!0,fontColor:"#ff6961",fontSize:16},gridLines:{offsetGridLines:!1}}],yAxes:[{ticks:{beginAtZero:!0,fontColor:"#ff6961",fontSize:14},scaleLabel:{display:!0,fontColor:"#ff6961",fontSize:16}}]},tooltips:{enabled:!1,custom:function(t){var e=d3.select("#chartjs-histogram-tooltip");if(e.empty()&&(e=createThemedTooltip(d3.select("body")).attr("id","chartjs-histogram-tooltip").style("transition","left 0.3s, top 0.3s")),0!==t.opacity){if(t.body){var r=(t.title||[])[0],a=t.body[0].lines[0],o=DATATYPES_DEFINITIONS[SELECTED_DATATYPE];e.select(".tooltip-title").text(r+" "+o.suffixName),e.select(".tooltip-value").text(a),"General"==SELECTED_DATATYPE?e.select(".tooltip-sub-value").text(" days"):e.select(".tooltip-sub-value").text(" videos viewed")}var n=this._chart.canvas.getBoundingClientRect(),i=e.node().getBoundingClientRect();e.style("opacity",1),e.style("position","absolute"),e.style("left",n.left+window.pageXOffset+t.caretX+"px"),e.style("top",n.top+window.pageYOffset+t.caretY-i.height+"px")}else e.style("opacity",0)}}}})}function updateHistogram(t){if("General"==SELECTED_DATATYPE){var e=d3.nest().key(function(t){var e=new Date(t.time);return e.setHours(0),e.setMinutes(0),e.setSeconds(0),e.setMilliseconds(0),e.getFullYear()+"-"+("0"+(e.getMonth()+1)).slice(-2)+"-"+("0"+(e.getDate()+1)).slice(-2)});e=(e=e.rollup(function(t){return t.length})).entries(t),i=[];for(var r=0,a=Object.entries(e);r<a.length;r++){var o=_slicedToArray(a[r],2),n=(o[0],o[1]);i.push(n.value)}}else{var i=t.map(function(t){return t[SELECTED_DATATYPE]});i.sort(function(t,e){return e-t})}var s,l=d3.min(i),c=d3.max(i),u=Math.log10(l+1),f=Math.log10(c+1);s="General"==SELECTED_DATATYPE?d3.range(l,c,Math.round((c-l)/15)):d3.range(u,f,(f-u)/15).map(function(t,e){return prettyPowerOf10(t,0==e?Math.floor:Math.round)});var d=d3.histogram().domain([l,c]).thresholds(s)(i).map(function(t){return t.length});s.push(prettyPowerOf10(f,Math.ceil));var T=s.slice(0,-1).map(function(t,e){return"["+DATATYPES_DEFINITIONS[SELECTED_DATATYPE].format(t,c)+"; "+DATATYPES_DEFINITIONS[SELECTED_DATATYPE].format(s[e+1],c)+")"}),E=s.map(function(t){return DATATYPES_DEFINITIONS[SELECTED_DATATYPE].format(t,c)});"General"==SELECTED_DATATYPE?$("#histogramTitle").text("Histogram of daily amount of watched videos"):$("#histogramTitle").text("Histogram of watched videos by "+SELECTED_DATATYPE.toLowerCase()),histogramChart.data.datasets[0].data=d,histogramChart.options.scales.xAxes[0].labels=T,histogramChart.options.scales.xAxes[1].labels=E,histogramChart.options.scales.xAxes[1].scaleLabel.labelString="General"==SELECTED_DATATYPE?"Viewed videos":SELECTED_DATATYPE,histogramChart.options.scales.yAxes[0].scaleLabel.labelString="General"==SELECTED_DATATYPE?"Number of days":"Number of videos",histogramChart.update()}
"use strict";var _apiData={};function getDataFromAPI(t,i,s,e){for(var a=t.filter(function(t){return!_apiData[t]}),o=i||function(){},u=s||function(){},c=e||function(){},r=0,p=Math.ceil(a.length/50),l=0,n=0;n<5;n++)d();function d(){r+=1,function i(){var t=a.slice(0,50).map(function(t){return"&id="+t}).join("");if(0==t.length)return void(0==--r&&o(_apiData));a=a.slice(50);var s=new XMLHttpRequest;s.open("GET","https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics%2Cstatus"+t+"&key=AIzaSyAwPHCX3POkrRAeqqir-op4yTSgtxKyRbY",!0);s.onreadystatechange=function(t){4==s.readyState&&(200==s.status?e(JSON.parse(s.response)):n(JSON.parse(s.response).error))};s.send(null);function e(t){t.items.forEach(function(t){t.id&&t.status&&"public"==t.status.privacyStatus&&t.status.publicStatsViewable&&t.statistics.likeCount&&t.statistics.dislikeCount&&t.statistics.viewCount&&t.statistics.commentCount&&(_apiData[t.id]={likes:t.statistics.likeCount,dislikes:t.statistics.dislikeCount,views:t.statistics.viewCount,comments:t.statistics.commentCount,thumbnail:t.snippet.thumbnails.high.url,language:t.snippet.defaultAudioLanguage,category:t.snippet.categoryId,published:t.snippet.publishedAt,duration:t.contentDetails.duration})}),c((l+=1)/p),i()}function n(t){console.error("Execute error",t),0<r&&(r=0,a=[],u(t))}}()}}
"use strict";var FULL_DATA;function updateAllCharts(){if(SELECTED_DATATYPE&&FULL_DATA){var t=filterData(FULL_DATA);updateMmmChart(t),updateLinePlot(t),updateHeatMap(t),updateHistogram(t)}}function prettyPowerOf10(t,a){var r=Math.pow(10,t)-1;if(0==r)return 0;var i=Math.pow(10,Math.floor(Math.log10(r)-1));return(a=a||Math.round)(r/i)*i}initHeatMap(),initLinePlot(),initHistogram();
"use strict";function ownKeys(t,e){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(t);e&&(n=n.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),r.push.apply(r,n)}return r}function _objectSpread(t){for(var e=1;e<arguments.length;e++){var r=null!=arguments[e]?arguments[e]:{};e%2?ownKeys(Object(r),!0).forEach(function(e){_defineProperty(t,e,r[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):ownKeys(Object(r)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(r,e))})}return t}function _defineProperty(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}var SELECTED_DATATYPE,DATATYPES_DEFINITIONS={General:{icon:"fas fa-chart-area",filterable:!1,suffixName:"videos viewed"},"Times viewed":{preFormula:function(e,t){return t[e.id]=(t[e.id]||0)+1,t},formula:function(e,t){return t[e.id]},icon:"fas fa-redo-alt",selectable:!1},"Total views":{formula:function(e){return parseInt(e.views)},icon:"fas fa-eye"},"Total likes":{formula:function(e){return parseInt(e.likes)},icon:"fas fa-thumbs-up"},"Likes per thousand views":{formula:function(e){return e.likes/e.views*1e3},icon:"far fa-thumbs-up"},"Total dislikes":{formula:function(e){return parseInt(e.dislikes)},icon:"fas fa-thumbs-down"},"Dislikes per thousand views":{formula:function(e){return e.dislikes/e.views*1e3},icon:"far fa-thumbs-down"},"Like to dislike ratio":{formula:function(e){return e.likes==e.dislikes?.5:e.likes/Math.max(1,+e.likes+ +e.dislikes)*10},icon:"fas fa-star-half-alt"},"Total comments":{formula:function(e){return parseInt(e.comments)},icon:"fas fa-comment"},"Comments per thousand views":{formula:function(e){return e.comments/e.views*1e3},icon:"far fa-comment"},Duration:{formula:function(e){return moment.duration(e.duration,moment.ISO_8601).asSeconds()},userParser:function(e){if(parseInt(e)==e)return parseInt(e);if(2==e.split(":").length)return moment.duration("0:"+e).asSeconds();if(/H|M|S/i.test(e)&&!/PT/i.test(e))return moment.duration("PT"+e.toUpperCase().replace(/ /g,"")).asSeconds();var t=moment.duration(e).asSeconds();return 0!=t?t:void 0},format:function(e){var t=moment.utc(1e3*e).format("mm:ss");return 3600<=e&&(t=moment.utc(1e3*e).format("HH:")+t),86400<=e&&(t=Math.floor(e/86400)+"D "+t),t},suffixName:"",icon:"far fa-clock"}};function parseDatatypes(e){var n={};return e.map(function(e){for(var t in DATATYPES_DEFINITIONS)DATATYPES_DEFINITIONS[t].preFormula&&(n[t]=DATATYPES_DEFINITIONS[t].preFormula(e,n[t]||{}));return e}).map(function(e){var t={id:e.id,thumbnail:e.thumbnail,time:Date.parse(e.time)};for(var r in DATATYPES_DEFINITIONS)DATATYPES_DEFINITIONS[r].formula&&(t[r]=DATATYPES_DEFINITIONS[r].formula(e,n[r]),isNaN(t[r])&&(console.warn("NaN in "+r,e),t[r]=0));return t})}!function(n){function a(e){var t=DATATYPES_DEFINITIONS[e];t&&(n("#datatypeSelector i").attr("class",t.icon),n("#datatypeSelector span").text(e),SELECTED_DATATYPE=e,updateAllCharts())}!function(){var e={formula:!1,icon:"fas fa-asterisk",color:"primary",format:function(e,t){var r=parseFloat(e)||0;return(999<r||t&&999<t)&&(r=Math.round(r)),r.toLocaleString()},userParser:parseInt,filterable:!0,selectable:!0};for(var t in DATATYPES_DEFINITIONS)DATATYPES_DEFINITIONS[t]=_objectSpread(_objectSpread({suffixName:t.toLowerCase()},e),DATATYPES_DEFINITIONS[t])}(),function(){var e=n("#collapseDatatypes .collapse-inner");for(var t in DATATYPES_DEFINITIONS)if(DATATYPES_DEFINITIONS[t].selectable){var r=document.createElement("a");r.textContent=t,r.href="#",r.className="collapse-item",r.setAttribute("datatype",t),r.onclick=function(e){a(this.getAttribute("datatype"))},e.append(r)}}(),a(Object.keys(DATATYPES_DEFINITIONS)[0])}(jQuery);
"use strict";function newFilter(t){var e=$("#filterTemplate").clone(!0),i=DATATYPES_DEFINITIONS[t],a="filter-"+t.toLowerCase().replace(/ /g,"-");e.attr("id",a),e.attr("filter-by",t),e.find('*[data-target="#TMPCollapse"]').attr("data-target","#Collapse-"+a),e.find('*[aria-controls="TMPCollapse"]').attr("aria-controls","Collapse-"+a),e.find("#TMPCollapse").attr("id","Collapse-"+a),e.find('*[aria-labelledby="TMPDropdown"]').attr("aria-labelledby","Dropdown-"+a),e.find("#TMPDropdown").attr("id","Dropdown-"+a),e.find(".nav-link span").text(t),e.find(".nav-link i").attr("class",i.icon),e.on("click",".dropdown-item",function(){var t=$(this).parentsUntil("li.nav-item").parent(),e=this.textContent;-1==e.indexOf(" ")?(e+=" ",t.find(".second-filter").hide()):t.find(".second-filter").show(),t.find(".dropdown-toggle").text(e.slice(0,e.indexOf(" "))+" "),t.find(".input-group-text").text(e.slice(e.indexOf(" ")));var i=$(this).attr("switch-to");t.find(".first-filter-input").attr("placeholder",1==i?"Maximum":"Minimum").attr("aria-label",1==i?"Maximum":"Minimum"),t.attr("filter-type",i),updateAllCharts()}),e.find(".dropdown-item:first-child").click(),e.on("change","input",function(){updateAllCharts()}),e.on("click",".delete-button",function(){$(this).parentsUntil("li.nav-item").parent().remove(),updateNewFilterMenu(),updateAllCharts()}),e.insertBefore("#filterTemplate").show(),e.find(".collapse").collapse("show"),updateNewFilterMenu()}function updateNewFilterMenu(){var t=$("#collapseNewFilter .collapse-inner");t.find("a").remove();var e=!0;for(var i in DATATYPES_DEFINITIONS)if(DATATYPES_DEFINITIONS[i].filterable&&!$('.nav-item[filter-by="'+i+'"]').length){e=!1;var a=document.createElement("a");a.textContent=i,a.href="#",a.className="collapse-item",a.setAttribute("datatype",i),a.onclick=function(t){newFilter(this.getAttribute("datatype")),t.stopPropagation()},t.append(a)}e?$("#newFilterMenu").hide():$("#newFilterMenu").show()}function filterData(t){var l=[];if($(".nav-item[filter-by]").each(function(){var t=$(this).attr("filter-by"),e=$(this).attr("filter-type");if(0==e||1==e){var i=DATATYPES_DEFINITIONS[t].userParser($(this).find(".first-filter-input").val());if(isNaN(i))return;l.push("(v['"+t+"']"+(0==e?">":"<")+i+")")}else{var a=DATATYPES_DEFINITIONS[t].userParser($(this).find(".first-filter-input").val()),r=DATATYPES_DEFINITIONS[t].userParser($(this).find(".second-filter-input").val());if(isNaN(a)&&isNaN(r))return;var n="(";isNaN(a)||(n+="v['"+t+"']>"+a),isNaN(a)||isNaN(r)||(n+=2==e?"&&":"||"),isNaN(r)||(n+="v['"+t+"']<"+r),n+=")",l.push(n)}}),0==l.length)return t;var e=new Function("v","return ("+l.join(" && ")+")");return t.filter(e)}$("#filterTemplate").hide(),updateNewFilterMenu();
"use strict";function newDatasetImported(e,t){console.log("Saving dataset to memory: "+e),localStorage.setItem(e,JSON.stringify(t)),currentlyOpenDataset=e,loadDatasetFromArray(t),updateDatasetMenu()}function loadDatasetFromArray(e){e=parseDatatypes(e),FULL_DATA=e,updateAllCharts()}function loadDatasetFromMemory(e){console.log("Loading dataset: "+e),currentlyOpenDataset=e;try{loadDatasetFromArray(JSON.parse(localStorage.getItem(e)))}catch(e){console.error("Couldn't load dataset from memory",e)}}var datasetFlaggedForDeletion=currentlyOpenDataset="";function removeDatasetFromMemoryModal(e){datasetFlaggedForDeletion=e,$("#confirmDeletionName").text(e),$("#confirmDeletionModal").modal("show")}function removeDatasetFromMemory(e){console.log("Removing dataset: "+e),localStorage.removeItem(e),updateDatasetMenu(),currentlyOpenDataset==e&&(Object.keys(localStorage)?loadDatasetFromMemory(Object.keys(localStorage)[0]):(currentlyOpenDataset="",loadDatasetFromArray([])))}function updateDatasetMenu(){var e=$("#collapseDatasets div");e.find("a").remove();for(var t=0,a=Object.keys(localStorage);t<a.length;t++){var o=a[t],r=document.createElement("a");r.textContent=o,r.href="#",r.className="collapse-item",r.setAttribute("dataset",o),r.onclick=function(e){loadDatasetFromMemory(this.getAttribute("dataset"))};var l=document.createElement("button");l.className="close",l.style.fontSize="1.1rem",l.onclick=function(e){removeDatasetFromMemoryModal(this.parentNode.getAttribute("dataset")),e.stopPropagation()};var n=document.createElement("icon");n.className="fas fa-trash text-danger",l.appendChild(n),r.appendChild(l),e.append(r)}}updateDatasetMenu(),Object.keys(localStorage)[0]?loadDatasetFromMemory(Object.keys(localStorage)[0]):($("#importDatasetModal").addClass("modal-lock"),$("#importDatasetModal").modal({backdrop:"static",keyboard:!1})),$(document).on("click",".btn-confirm-deletion",function(e){removeDatasetFromMemory(datasetFlaggedForDeletion)});
"use strict";function ownKeys(t,e){var r=Object.keys(t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(t);e&&(o=o.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),r.push.apply(r,o)}return r}function _objectSpread(t){for(var e=1;e<arguments.length;e++){var r=null!=arguments[e]?arguments[e]:{};e%2?ownKeys(Object(r),!0).forEach(function(e){_defineProperty(t,e,r[e])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(r)):ownKeys(Object(r)).forEach(function(e){Object.defineProperty(t,e,Object.getOwnPropertyDescriptor(r,e))})}return t}function _defineProperty(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}!function(i){var n="";i(document).on("change",".btn-file :file",function(e){n=e.target.files[0];var t=i(this).parents(".input-group").find(":text");n?(t.val(n.name),i(this).parents(".input-group").find("+ .alert").hide()):t.val("")}),i(document).on("click",".btn-takeout-import",function(e){var t=!1;if(i("#datasetName").val()||(t=!0,i("#datasetName + .alert").show()),n||(t=!0,i("#takeout-file-selector + .alert").text("Select a file").show()),!t)try{var r=new FileReader;r.onload=function(e){!function(e){try{var r=JSON.parse(e);if(0==(r=r.filter(function(e){return e.time&&e.titleUrl&&-1!=e.titleUrl.indexOf("watch?v=")})).length)throw"Dataset is empty or invalid";var o={};r=r.map(function(e){var t={id:e.titleUrl.slice(e.titleUrl.indexOf("watch?v=")+8),time:e.time};return o[t.id]=!0,t});Object.keys(o);n="";var a=i("#datasetName").val();i("#takeout-file-selector").find(":text").val(""),i("#datasetName").val(""),i("#importDatasetModal").removeClass("modal-lock"),i("#importDatasetModal").modal("hide");var t=function(e){e=Math.floor(100*e),i("#importProgressModal .progress-bar").css("width",e+"%").attr("aria-valuenow",e).text(e+"%")};t(0),i("#importProgressModal").modal({backdrop:"static",keyboard:!1}),getDataFromAPI(Object.keys(o),function(t){i("#importProgressModal").modal("hide"),setTimeout(function(){i("#importProgressModal").modal("hide")},1e3),r=r.filter(function(e){return t[e.id]}).map(function(e){return _objectSpread(_objectSpread({},t[e.id]),e)}),newDatasetImported(a,r)},function(e){i("#importProgressModal").modal("hide"),setTimeout(function(){i("#importProgressModal").modal("hide")},1e3),i("#importErrorModal .error-message").text(e.code+":\n"+e.message),i("#importErrorModal").modal("show")},t)}catch(e){i("#takeout-file-selector + .alert").text("Invalid file").show(),console.error(e)}}(e.target.result)},r.readAsText(n)}catch(e){i("#takeout-file-selector + .alert").text("Couldn't load file").show(),console.error(e)}}),i(document).on("change keyup paste","#datasetName",function(e){i(this).find("+ .alert").hide()}),i("#datasetName + .alert").hide(),i("#takeout-file-selector + .alert").hide()}(jQuery);